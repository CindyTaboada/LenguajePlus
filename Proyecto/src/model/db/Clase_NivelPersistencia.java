...
public class Clase_NivelPersistencia {
    ...
    public ArrayList<ClaseNiveles> leerTodasLasRelaciones() {
        ArrayList<ClaseNiveles> relaciones = new ArrayList<>();
        ...
        try {
            ...
            while (rslt.next()) {
                relaciones.add(new ClaseNiveles(
